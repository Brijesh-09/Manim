...
<div className="flex flex-wrap justify-center gap-2 items-center px-4 mt-4">
  <div className="text-center">
    <HoverBorderGradient
      ...
      className="dark:bg-white bg-black text-white dark:text-black flex items-center space-x-2 px-4 py-2 text-sm sm:text-base"
    >
